...
[oldSenderData] = ReadDataFromFile(".\measurements\old\ds4.txt", dataPoints, 2);
[oldReceiverData] = ReadDataFromFile(".\measurements\old\ds4r.txt", dataPoints, 2);
...
grid on
title('Graph to show DatagramSocket 4')
xlabel('Block')
ylabel('Delay')
