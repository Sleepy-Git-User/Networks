...
[oldSenderData] = ReadDataFromFile(".\measurements\old\ds3.txt", dataPoints, 2);
[oldReceiverData] = ReadDataFromFile(".\measurements\old\ds3r.txt", dataPoints, 2);
...
grid on
title('Graph to show DatagramSocket 3')
xlabel('Block')
ylabel('Delay')
