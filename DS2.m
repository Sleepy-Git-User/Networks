...
[oldSenderData] = ReadDataFromFile(".\measurements\old\ds2.txt", dataPoints, 2);
[oldReceiverData] = ReadDataFromFile(".\measurements\old\ds2r.txt", dataPoints, 2);
...
grid on
title('Graph to show DatagramSocket 2')
xlabel('Block')
ylabel('Delay')
